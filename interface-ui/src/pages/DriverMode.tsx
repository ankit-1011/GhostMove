      ...
      <div className="max-w-4xl mx-auto">
        ...
        {!isConnected ? (
          <div className="glass-card p-12 text-center">
            ...
            <a
              href="#"
              className="inline-block px-6 py-3 bg-gradient-to-r from-teal-500 to-violet-500 text-white font-semibold rounded-lg hover:from-teal-400 hover:to-violet-400 transition-all"
            >
              Go to Home
            </a>
          </div>
