      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-wrap gap-6 justify-center">
            <a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">Twitter</a>
            <a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">GitHub</a>
            <a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">Demo-Vedio</a>
